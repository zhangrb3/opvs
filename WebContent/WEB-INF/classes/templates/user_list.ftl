  ...
  <tr>
    ...
    <td width="500" height="200"><table width="500" height="200" border="1" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">Age</span></td>
      </tr>
      <#list users as user>
      <tr>
        ...
        <td width="160" height="65" align="center" valign="middle"><span class="STYLE15">${user.age}</span></td>
      </tr>
      </#list>
    </table></td>
    <td width="500" height="200">&nbsp;</td>
